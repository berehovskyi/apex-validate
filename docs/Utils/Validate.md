...
**See** [Validate.nonNegative](Validate.nonNegative)
...
##### `public static void nonNegative(Decimal value)`
...
###### Example
```apex
Validate.nonNegative(-1); // throws an IllegalArgumentException
```


##### `public static void nonNegative(Decimal value, String message)`
...
##### `public static void nonNegative(Decimal value, String message, List<Object> arguments)`
